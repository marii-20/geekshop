...
urlpatterns = [
    ...
    path('categoriaes/create/', admin_views.category_create, name='category_create'),
    ...
    path('categories/update/<int:pk>/', admin_views.category_delete, name='category_delete'),
    ...
    path('products/update/<int:pk>/', admin_views.product_delete, name='product_delete'),
